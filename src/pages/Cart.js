      ...
      {/* cart */}
        <div className="2xl:container 2xl:max-w-screen-2xl 2xl:mx-auto p-3 md:mb-10 2xl:mb-52">
          <div className="flex flex-col md:flex-row justify-between md:px-5 lg:px-10">
            ...
            >
              {/* navigation */}
              <div className="justify-between items-center hidden md:flex dark:text-white">
                <p>سبد خرید</p>
                <Link to={"/"} className="text-red-500 dark:text-white">
                  بازگشت به فروشگاه
                </Link>
              </div>
              {products.length ? (
                ...
                <div className="flex flex-col items-center md:mt-20 my-5">
                  <h2 className="md:text-2xl mb-5 text-xl dark:text-white">
