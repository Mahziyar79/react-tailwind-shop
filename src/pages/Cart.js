    ...
    <>
      ...
      <div className="2xl:container 2xl:max-w-screen-2xl 2xl:mx-auto p-3 md:mb-10">
        <div className="flex flex-col md:flex-row justify-between md:px-5 lg:px-10">
          <div className={`flex flex-col gap-y-4  md:mt-4 ${products.length ? "md:w-[60%]" : "md:w-[100%] my-20"}`}>
            {/* navigation */}
            ...
            <div className="mt-4 md:w-[45%] md:mr-5 lg:mr-0 lg:w-[35%]">
              <div className="bg-white rounded-md p-3 md:p-5 flex flex-col gap-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-orange-700">1,750,000 تومان</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span>تخفیف</span>
                  <span className="text-orange-700">750,000 تومان</span>
                </div>
                <div className="flex items-center justify-between mt-5">
                  <span>قیمت نهایی</span>
                  <span className="text-orange-700">1,000,000 تومان</span>
                </div>
              </div>
              {/* buy process */}
