...
const About = () => {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-[80%] m-auto my-10 md:mb-28">
        <div className="w-[100%] lg:w-[70%]">
          <h2 className="text-2xl lg:text-4xl mb-3 dark:text-white">به صفحه درباره ما خوش آمدید</h2>
